...
HF_TOKEN     = os.getenv("HF_TOKEN",     "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")
...
def log_step(step: int, action: str, reward: float, done: bool, error: Optional[str]):
    ...
    # Sanitize action string — no newlines, truncate if too long
...
def main():
    ...
    print(f"[SUMMARY] tasks={len(all_results)} avg_score={avg:.3f}", flush=True)
